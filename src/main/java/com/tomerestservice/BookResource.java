 ...
 *
 */
// books will be the pathsegment that precedes any path segment specified by @Path on a method.
@Path("/books")
public class BookResource {
    ...
    public Response getBookById(@PathParam("id") String id/* The {id} placeholder parameter is resolved */) {
